...
const Features = () => {
  ...
  return (
    <section
      id="features"
      className="py-12 md:py-16 lg:py-20 relative bg-gradient-to-b from-orange-100 to-white/70"
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10">
          ...
          <button
            onClick={() => scroll("prev")}
            className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 bg-orange-500 shadow-md rounded-full w-10 h-10 items-center justify-center z-20 hover:bg-orange-600 transition text-white"
          >
            ‹
          </button>
          ...
          <button
            onClick={() => scroll("next")}
            className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 bg-orange-500 shadow-md rounded-full w-10 h-10 items-center justify-center z-20 hover:bg-orange-600 transition text-white"
          >
            ›
          </button>
          ...
          <div
            ref={scrollRef}
            className="flex overflow-x-auto scrollbar-hide gap-6 pb-4 scroll-snap-x scroll-smooth px-4 md:px-8"
          >
